...
print(funciones.last_word_len(phrase))
...
print(funciones.multiplos(n1,n2))
...
while days !=0:
    ...
    print(f"la temperatura media es de {funciones.temperature(min,max,avg)}")
    days= days - 1
...
print(f"El perimetro y area del circulo son: {funciones.circle(radius)}")
...
print(funciones.vector_length(vector))
